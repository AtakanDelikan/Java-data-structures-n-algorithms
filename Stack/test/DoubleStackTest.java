...
public class DoubleStackTest {
 ...
 "top must be the last element; toString from bottom must start with -8.5 7.14 ", 
  ...
  @Test (expected=RuntimeException.class)
   ...
   @Test (expected=RuntimeException.class)
   public void testUnderflowSWAP() {
      String s = "3. SWAP";
      DoubleStack.interpret (s);
   }

   @Test (expected=RuntimeException.class)
   public void testUnderflowDUP() {
      String s = "DUP 1. 5.";
      DoubleStack.interpret (s);
   }

   @Test (expected=RuntimeException.class)
   public void testUnderflowROT() {
      String s = "3. 2. ROT";
      DoubleStack.interpret (s);
   }
   ...
   public void SWAPfunctionality() {
      ...
      m2.push (5.);
      m2.op("SWAP");
      assertTrue ("SWAP should swap top most 2 elements ;", m1.equals(m2));
   }
   @Test (timeout=1000)
   public void DUPfunctionality() {
      DoubleStack m1 = new DoubleStack();
      m1.push (5.);
      m1.push (5.);
      DoubleStack m2 = new DoubleStack();
      m2.push (5.);
      m2.op("DUP");
      assertTrue ("DUP should duplicate top element ;", m1.equals(m2));
   }
   @Test (timeout=1000)
   public void ROTfunctionality() {
      DoubleStack m1 = new DoubleStack();
      m1.push (2.);
      m1.push (3.);
      m1.push (1.);
      ...
      m2.push (3.);
      m2.op("ROT");
      assertTrue ("ROT should rotate top most 3 elements ;", m1.equals(m2));
   }

...
public class LfractionTest {
   ...
   @Test (timeout=1000)
   public void testPow() {
      Lfraction q1 = new Lfraction (5L, 2L);
      Lfraction q2 = q1.pow(0);
      Lfraction q3 = new Lfraction (1L, 1L);
      assertTrue ("pow(0) should return 1/1", q2.equals(q3));

      q1 = new Lfraction (73L, 13L);
      q2 = q1.pow(1);
      assertTrue ("pow(1) should return fraction that is equal to itself", q2.equals(q1));
      assertFalse ("pow(1) shouldn't return identical object", q1 == q2);

      q1 = new Lfraction (-374L, 5341L);
      q2 = q1.pow(-1);
      q3 = q1.inverse();

      assertTrue ("pow(-1) should return inverse of the fraction", q2.equals(q3));

      q1 = new Lfraction (-7L, 2L);
      q2 = q1.pow(3);
      q3 = new Lfraction (-343L, 8L);

      assertTrue ("(-7/3)pow(3) should be equal to -343/8", q2.equals(q3));

      q1 = new Lfraction (-5L, 6L);
      q2 = q1.pow(4);
      q3 = new Lfraction (625L, 1296L);
      assertTrue ("(-5/3)pow(4) should be equal to 625/1296", q2.equals(q3));

      q1 = new Lfraction (-11L, 19L);
      q2 = q1.pow(-3);
      q3 = new Lfraction (-6859L, 1331L);
      assertTrue ("(-11/19)pow(-4) should be equal to -6859/1331", q2.equals(q3));
   }

   @Test (expected=RuntimeException.class)
   public void testPowMinusOne() {
      Lfraction q1 = new Lfraction (0, 5);
      Lfraction q2 = q1.pow(-1);
   }
